...
// reconcileProxyCerts ensures the trusted CA ConfigMap has the expected injection request. Patches the object if not.
// Also ensures that Windows nodes have an up-to-date trusted CA bundle
